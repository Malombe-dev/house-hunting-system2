...
exports.register = async (req, res, next) => {
  try {
    ...
    //   message: `Please verify your email by clicking: ${process.env.CLIENT_URL}/verify-email/${verificationToken}`
    // });
...
exports.logout = async (req, res, next) => {
  try {
    ...
    // But we can blacklist the token or log the logout event
