...
const AdminLayout = () => {
  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      current: location.pathname === '/admin/property-approvals',
      badge: 5 // Example pending approvals count
    },
    {
      name: 'Dispute Management',
      href: '/admin/disputes',
      icon: ExclamationTriangleIcon,
      current: location.pathname === '/admin/disputes',
      badge: 2 // Example disputes count
    },
    {
      name: 'Analytics',
